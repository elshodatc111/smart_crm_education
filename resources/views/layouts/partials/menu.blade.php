...
<li class="nav-item">
  <a class="nav-link {{ request()->routeIs(['setting_payment','setting_cours','setting_region','setting_cours_show','setting_dam_olish']) ? '' : 'collapsed' }}" data-bs-target="#setting-nav" data-bs-toggle="collapse" href="#">
    <i class="bi bi-calendar2-check"></i><span>Sozlamalar</span><i class="bi bi-chevron-down ms-auto"></i>
  </a>
  <ul id="setting-nav" class="nav-content collapse {{ request()->routeIs(['setting_payment','setting_cours','setting_dam_olish','setting_region','setting_cours_show']) ? 'show' : '' }}" data-bs-parent="#sidebar-nav">
    <li>
    ...
    <li>
      <a href="{{ route('setting_dam_olish') }}" class="nav-link {{ request()->routeIs(['setting_dam_olish']) ? '' : 'collapsed' }}">
        <i class="bi bi-dot"></i><span>Dam olish kunlari</span>
      </a>
    </li>
  </ul>
</li>
